...
module.exports = function(grunt) {
    grunt.registerMultiTask('generate_index', 'Generate a project homepage from a directory structure', function() {
        ...
        this.files.forEach(function(f) {
            ...
            f.src.forEach(buildDataStructure.bind(this, options, directoryStructure.modules,f.dest));
    ...
    function buildDataStructure(options, directoryStructure,filedest, filepath) {
        ...
        addFileLocationToDirectoryStructure(directoryStructure, directories, relativefilepath, filepath, 0);
    }
    ...
    function addFileLocationToDirectoryStructure(directoryStructure, directories, relativefilepath, filepath, level) {
        ...
        if (directories.length === 1) {
            ...
            addFileLocationToDirectoryStructure(folder.children, directories.slice(1), relativefilepath, filepath, level + 1);
        }
    }
